function Saxonce() {
  var P = '',
    ...
    ib = '"><\/script>',
    Z = '#',
		Xb = '.cache.html?integrationInstance=' + integrationInstance,
    _ = '/',
    lb = '//',
    Qb = '19969A4E1BAF2CE01CE393669CA7071E',
    Rb = '209262B7AE3C7AEAE598A5F2A81C2D52',
    Sb = '2B9994542D8FDA44D85CD1DDDBF33D0F',
    Tb = '6E1196E4299C61E3A5F8C925D5F2032F',
    Ub = '7FFD07C49946B3F4B1DE49E72F7E85FA',
    Wb = ':',
    pb = '::',
    Zb = '<script defer="defer">Saxonce.onInjectionDone(\'Saxonce\')<\/script>',
    hb = '<script id="',
    sb = '=',
    $ = '?',
    ub = 'Bad handler "',
    Vb = 'D30ABA3918632FE99712FDC714F7D237',
    Yb = 'DOMContentLoaded',
    jb = 'SCRIPT',
    Q = 'Saxonce',
		eb = 'Saxonce.nocache.js?integrationInstance=' + integrationInstance,
    ob = 'Saxonce::',
    gb = '__gwt_marker_Saxonce',
    kb = 'base',
    cb = 'baseUrl',
    T = 'begin',
    S = 'bootstrap',
		bb = 'clear.cache.gif?integrationInstance=' + integrationInstance,
    rb = 'content',
    Y = 'end',
    Kb = 'gecko',
    Lb = 'gecko1_8',
    ...
    qb = 'gwt:property',
		Ob = 'hosted.html?Saxonce&integrationInstance=' + integrationInstance,
    Jb = 'ie6',
    Ib = 'ie8',
    Hb = 'ie9',
    yb = 'iframe',
  ...
  Saxonce.onScriptLoad = function () {
    if (I) {
      r = true;
      C()
    }
  };
  Saxonce.onInjectionDone = function () {
    q = true;
    o && o({
      moduleName: Q,
      sessionId: p,
